  ...
  return (
    <div className="space-y-6 relative dashboard-page" dir={direction}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <StatCard 
          title={t('total_sales')} 
          value={formatCurrency(110894.50, systemSettings)} 
          icon={DollarSign} 
        ...
        <StatCard 
          ...
          value={formatCurrency(32506.50, systemSettings)} 
          icon={ShoppingBag} 
        ...
        <StatCard 
          title={t('net_profit')} 
          value={formatCurrency(78388.00, systemSettings)} 
          icon={TrendingUp} 
        ...
        <StatCard 
          ...
          value={formatCurrency(12450.00, systemSettings)} 
          icon={CreditCard} 
